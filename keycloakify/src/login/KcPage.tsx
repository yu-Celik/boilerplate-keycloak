...
// Add CSS class overrides here to restyle specific Keycloak UI elements.
// Keys correspond to the ClassKey union from keycloakify/login.
// Example: kcFormGroupClass: "my-form-group"
